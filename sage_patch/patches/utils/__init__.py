...
extension shares, the INI field-parse tables that give a block a new keyword, the `KindOf` mask,
and the null function pointer that lets two income patches agree on a multiplier without either
