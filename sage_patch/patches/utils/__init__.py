...
extension shares, the `KindOf` mask, and the null function pointer that lets two income patches
agree on a multiplier without either reading the other's bytes.
